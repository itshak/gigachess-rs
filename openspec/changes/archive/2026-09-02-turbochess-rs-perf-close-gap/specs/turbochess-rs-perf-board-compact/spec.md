...
Explores a compact `Board` layout probe behind a `compact` feature to reduce the 368B `Copy` board (mailbox + 4 rook squares + 64B mask) toward ultrachess ~100B, measuring clone and movegen gains while keeping Chess960 compat.
